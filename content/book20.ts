...
export const book20: Book = {
    id: 20,
    title: 'IELTS Practice Book 20',
    description: 'Advanced practice for pushing your score to the next level.',
    lessons: createPlaceholderLessons(20),
};